...
- **iZotope** mantiene gratis de forma permanente su plugin **Vinyl** (simulación de polvo, rayas y wow del vinilo) y tiene una [colección completa de plugins gratis](https://www.izotope.com/collections/free-audio-plug-ins) de mezcla y masterización.
- **Plugin Alliance** entrega 20 plugins gratis al crear una cuenta —entre ellos bx_masterdesk Classic, SPL Free Ranger y el filtro Elysia niveau—, sin costo ni límite de tiempo.
- **Waves** no regala su catálogo completo, pero lanza plugins totalmente gratis por tiempo limitado varias veces al año (como Curves Resolve a inicios de 2026) y tiene ventas semestrales donde plugins bajan hasta 90%, quedando bajo los $35 dólares.
- **Universal Audio** sigue siendo la marca menos "gratis" de esta lista, pero bajó drásticamente la barrera de entrada: su suscripción UAD Spark ofrece acceso a gran parte de su catálogo de emulaciones por una fracción del precio histórico, y su sección de doorbuster deals ofrece plugins individuales por menos de 30 dólares — algo impensado cuando esos mismos plugins solo corrían sobre hardware DSP propio.
...
- **Kilohearts Essentials**: más de treinta efectos gratis (utilidades, procesamiento creativo, herramientas de mezcla) que Kilohearts sigue ampliando sin costo adicional, usables como plugins normales o como snapins dentro de sus hosts modulares.
- **TDR Nova**, de Tokyo Dawn Records: un EQ dinámico gratuito que compite de igual a igual con EQs dinámicos pagos, muy usado en mezcla y masterización.
- **Valhalla Supermassive**, de Valhalla DSP: reverb y delay gratuitos de un desarrollador conocido por sus algoritmos de reverberación de gama alta — desde delays simples hasta texturas ambientales masivas.
- **Spitfire Audio LABS**: decenas de instrumentos gratis grabados con calidad orquestal (cuerdas, piano, coros, texturas experimentales), actualizados constantemente por uno de los sellos de librerías orquestales más respetados de la industria.
- **Surge XT**: sintetizador de código abierto y potencia profesional, usado incluso en producción cinematográfica y diseño sonoro pese a costar cero.
- **Chow Tape Model**: emulación de saturación a cinta hecha con modelado físico real, gratuita y de código abierto, considerada una de las simulaciones de cinta más precisas técnicamente disponibles.
