...
export const STUDIO_SERVICES = [
  ...
  {
    id: 'escucha',
    title: 'Escucha de discos',
    description:
      'Sesiones críticas de escucha en monitores Focal Twin 6Be, Yamaha HS5 y Avantone Mixcube, entre otros sistemas, para evaluar mezclas, masters o material en progreso.',
    imageKey: 'escucha',
  },
  {
    id: 'voiceover',
    title: 'Podcast Video Podcast y Voiceover',
    description:
      'Grabación y postproducción para voces en off, podcasts y contenido audiovisual con acústica tratada.',
    imageKey: 'voiceover',
  },
]
